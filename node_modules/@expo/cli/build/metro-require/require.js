    ...
    if (__DEV__) {
        ...
        if (initializingIndex !== -1) {
            const cycle = initializingModuleIds.slice(initializingIndex).map((id)=>{
                var ref;
                return ((ref = modules.get(id)) == null ? void 0 : ref.verboseName) ?? "[unknown]";
            });
...
function metroImportDefault(moduleId) {
    var ref;
    if (modules.has(moduleId) && ((ref = modules.get(moduleId)) == null ? void 0 : ref.importedDefault) !== EMPTY) {
...
function metroImportAll(moduleId) {
    var ref;
    if (modules.has(moduleId) && ((ref = modules.get(moduleId)) == null ? void 0 : ref.importedAll) !== EMPTY) {
...
if (__DEV__) {
    ...
    const runUpdatedModule = function(id, factory, dependencyMap) {
        ...
        if (hot._acceptCallback) {
            try {
                ...
                console.error(`Error while calling accept handler for module ${id}: `, error1);
            }
        }
        return false;
    };
    const performFullRefresh = (reason, modules)=>{
        if (typeof window !== "undefined" && window.location != null && typeof window.location.reload === "function") {
            ...
            if (Refresh != null) {
                var ref, ref1;
                const sourceName = ((ref = modules.source) == null ? void 0 : ref.verboseName) ?? "unknown";
                const failedName = ((ref1 = modules.failed) == null ? void 0 : ref1.verboseName) ?? "unknown";
